/**
 * Created by Billion on 8/15/2018.
 */
AmCharts.themes.patterns= {
    ...
    ,
    AmPieChart: {
        depth3D: 0, angle: 0, labelRadius: 10
    }
    ,
    AmSlicedChart: {
        outlineAlpha:0.3,
    ...
    ,
    AxisBase: {
        axisColor: "#000000", axisAlpha: 0.3, gridAlpha: 0.05, gridColor: "#000000"
    }
    ,
    ChartScrollbar: {
        backgroundColor: "#000000", backgroundAlpha: 0.13, graphFillAlpha: 0.4, selectedGraphFillAlpha: 0.7, graphLineAlpha: 0, selectedBackgroundColor: "#FFFFFF", selectedBackgroundAlpha: 0.9, gridAlpha: 0.15
    }
    ,
    ChartCursor: {
    ...
    ,
    AmLegend: {
        color: "#000000", markerBorderAlpha: 0.1, markerSize: 20, switchColor: "#000000"
    }
    ,
    AmGraph: {
        lineAlpha: 0.4, fillAlphas: 0.5
    }
    ,
    AmAngularGauge: {
        faceAlpha:0.5,
    ...
    ,
    GaugeArrow: {
        color: "#000000", alpha: 1, nailAlpha: 1, innerRadius: "0%", nailRadius: 15, startWidth: 15, borderAlpha: 1, radius: "70%", nailBorderAlpha: 1
    }
    ,
    GaugeAxis: {
        tickColor: "#000000", tickAlpha: 1, tickLength: 15, minorTickLength: 8, axisThickness: 1, axisColor: '#000000', axisAlpha: 1, bandAlpha: 1
    }
    ,
    TrendLine: {
    ...
    ,
    ZoomControl: {
        buttonRollOverColor: "#3c5bdc", buttonFillColor: "#f15135", buttonFillAlpha: 0.8
    }
    ,
    SmallMap: {
        mapColor: "#000000", rectangleColor: "#FFFFFF", backgroundColor: "#FFFFFF", backgroundAlpha: 0.7, borderThickness: 1, borderAlpha: 0.8
    }
    ,
    PeriodSelector: {
        color: "#000000"
    ...
    PeriodButtonSelected: {
        color: "#000000", backgroundColor: "rgba(0, 0, 0, 0.1)", border: "1px solid rgba(0, 0, 0, .3)", MozBorderRadius: "5px", borderRadius: "5px", margin: "1px", outline: "none", opacity: 1, boxSizing: "border-box"
    }
    ,
    PeriodInputField: {
    ...
    ,
    DataSetSelector: {
        color: "#000000", selectedBackgroundColor: "rgba(0, 0, 0, .25)", rollOverBackgroundColor: "rgba(0, 0, 0, .15)"
    }
    ,
    DataSetCompareList: {
