/**
 * Created by Billion on 8/14/2018.
 */
(function () {
...
(function () {
    ...
    e.PeriodSelector = e.Class({
        ...
        write: function (a) {
            ...
            b.position = g;
            b.div = a;
            a.innerHTML = '<fieldset style="border: none; padding:0;display: none"><legend style="display: none;">' +
            ...
            if (b.inputFieldsEnabled) {
                ...
                n.appendChild(f);
                k ? e.addBr(n) : (n.style.styleFloat = "left", n.style.display = "none");
            ...
            if (e.ifArray(n)) {
                ...
                f.appendChild(c);
                b.periodContainer = f;
                for (var t, c = 0; c < n.length; c++) l = n[c], t = document.createElement("input"), t.type = "button", t.value = l.label, t.period = l.period, t.count = l.count, t.periodObj = l, a && e.applyStyles(t.style, a.PeriodButton), k && (t.style.width = b.width - 1 + "px"), t.style.boxSizing = "border-box", t.style.backgroundColor = "#FFFFFF",t.style.border = "0px",t.style.borderColor = "#FFFFFF", f.appendChild(t), b.addEventListeners(t), l.button = t;
