...
var DatatableDataLocalDemo=function() {
    var e=function() {
        ...
        */
        ...
        var e = stocksJson;
        console.log("++++", e);
        var a=$(".earnings-data-table").mDatatable( {
            data: {
            ...
            , columns:[
	            ...
	            {
	                field: "open", title: "Open", width: 100
	            },
	            {
	                field: "change", title: "Change", width: 100
	            },
	            {
	                field: "changeOverTime", title: "Change Over Time", width: 100
	            },
	            {
	                field: "volume", title: "Volume", width: 100
	            },
	            {
	                field: "unadjustedVolume", title: "Unadjusted Volume", width: 100
	            },
	            {
	                field: "vwap", title: "VWAP", width: 100
	            }
             ...
             //    	textAlign: "center"
	            ...
	            // }
	        /*    , {
	                field:"date", title:"Date", responsive: {
	                }
	            }
	            , {
	                field: "high", title: "High", width: 100
    ...
    return {
        init:function() {
            ...
            stocksJson.length = 0;
			var srcJson = JSON.parse(jQuery('.earnings-data-table').attr('data-raw-data'));
			// console.log("Src json", srcJson);
			console.log("Src json parsed:", srcJson);
