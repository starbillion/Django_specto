                    ...
                    handleSearch: function(t) {
                        ...
                        0 === i.length && (a.dropdown.hide(), o.handleCancelIconVisibility("on"), o.closeDropdown(), n.removeClass(a.options.hasResultClass)), i.length < a.options.minLength || 1 == a.processing || (a.processing = !0, a.form.addClass(a.options.spinner), o.handleCancelIconVisibility("off"), e.ajax({
                            ...
                            success: function(e) {
                                ...
                                result_html = '<div class="m-list-search__results">';
                                result_html += '<span class="m-list-search__result-category m-list-search__result-category--first">Stocks</span>';
                                result_html += '<span class="m-list-search__result-message"><i class="fa fa-frown-o"></i> No record found</span>';
                                result_html += '</div>';
                                if (e.content.length > 0){
                                	result_html = '<div class="m-list-search__results"><span class="m-list-search__result-category m-list-search__result-category--first">Stocks</span>';
									for (var i=0; i<e.content.length; i++) {
										result_html += '<a href="'+STOCKS_URL+'/'+e.content[i].symbol.toUpperCase()+'/" class="m-list-search__result-item">';
										result_html += '<span class="m-list-search__result-item-text"> <b>'+ e.content[i].symbol +'</b> | '+e.content[i].name+'</span>';
										result_html += '</a>';
									}
									result_html += '</div>';
								}
								console.log("result html", result_html);
                                a.processing = !1, a.form.removeClass(a.options.spinner), o.handleCancelIconVisibility("on"), a.dropdown.setContent(result_html).show(), n.addClass(a.options.hasResultClass)
...
var mLayout = function() {
    var e, t, a, n, o = function() {
        ...
        c = function() {
            var e = $("#m_quicksearch");
            var searchUrl = jQuery('[data-url-config]').data('search-url');
            e.mQuicksearch({
